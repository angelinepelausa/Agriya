...
const MeatandPoultry = () => {
        ...
        const fetchProducts = async () => {
            try {
                const productsSnapshot = await firestore()
                    ...
                    .where('category', '==', 'Meatandpoultry') // Adjust this based on the category
                    .get();
    ...
    const handleCategoryPress = (item) => {
        ...
        if (item.name === 'MeatandPoultry') {
            navigation.navigate('MeatandPoultry'); // Navigate to the same screen
        } else {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.sectionTitle}>Meat and Poultry</Text>
